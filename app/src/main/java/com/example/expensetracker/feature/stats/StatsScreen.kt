...
fun StatsScreen(navController: NavController){
    Scaffold(topBar = {
        ...
        val dataState = viewModel.entities.collectAsState(emptyList())
        ...
        Column(modifier = Modifier.padding(it)) {
            ...
            // our same function of composable which we have used in home screen
            TransactionList(
                modifier = Modifier,
                list = topExpense.value,
                title = "Top Expenses",
                onDeleteExpense = { expense ->
                    // Trigger the delete operation using ViewModel
                    GlobalScope.launch {
